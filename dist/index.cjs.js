...
var Icon$x = function (props) {
    return (React__default['default'].createElement("img", { width: "24px", height: "24px", src: "/images/price-token.png" }));
};
...
var links = [
    ...
    },
    {
        ...
        icon: "ShieldIcon",
        href: "https://twitter.com/FortuneSwap/status/1367218225310818308",
        target: "_blank",
    },
    {
        label: "Bush",
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Github",
                href: "https://github.com/FortuneSwapFinance/",
                target: '_blank',
            },
            {
                label: "Docs",
                href: "https://FortuneSwapFinance.gitbook.io/fortuneswap/",
            },
            {
                label: "Blog",
                href: "https://fortuneswap.medium.com/",
            },
        ],
    },
];
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/FortuneSwapFinance",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/FortuneSwap",
    },
];
var MENU_HEIGHT = 64;
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://dex.guru/token/0x9A2af686fFaFf9B10C8B800c2261155ca9D3c5c2-bsc", target: "_blank" },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#ffffff", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#1B1464", textDisabled: "#BDC2C4", textSubtle: "#1B1464", borderColor: "#E9EAEB", card: "#FFFFFF", nav: "#f9fdf9", gradients: {
